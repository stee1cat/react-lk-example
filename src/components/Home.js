        ...
        return (
            <div className='page home'>
                <div className='page__top'>
                    ...
                    <p>A simple starting point for your React project with routing, data-fetching and state
                        management!</p>

                    <div>
                        <a className='btn btn--hasIcon' href='https://github.com/alexdevero/react-mobx-react-router-boilerplate' target='_blank'> Download
                            from GitHub </a>
                    </div>
                </div>
